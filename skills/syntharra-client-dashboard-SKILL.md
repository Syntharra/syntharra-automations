...
> Note: The internal admin dashboard (admin.syntharra.com) has been decommissioned. Client-facing dashboard remains active. Internal CRM operations now happen in HubSpot.
