...
if (businessHours && afterHoursTransfer !== 'all') {
  ...
  if (afterHoursTransfer === 'emergency_only') {
    afterHoursSection += `\nWhen a call comes in outside business hours:\n- Do NOT transfer regular calls. Instead, collect all details and say:\n  "We're currently outside our regular business hours. I've taken down all your details and our team will follow up first thing when we reopen."\n- Emergency calls CAN still be transferred to the emergency line.\n- Always still collect the caller's name, phone, and issue description.\n`;
  } else if (afterHoursTransfer === 'never') {
    afterHoursSection += `\nWhen a call comes in outside business hours:\n- Do NOT transfer ANY calls, including emergencies.\n- Collect all details and say:\n  "We're currently outside our regular business hours. I've recorded all your details as urgent and our team will follow up as soon as we reopen."\n- For emergencies, still collect details and mark as urgent, but do not attempt to transfer.\n`;
  }
}
...
const extractedData = {
  ...
  after_hours_transfer: afterHoursTransfer
};
