...
| 2026-04-04 | E2E Test | Standard E2E Phase 2 fails — onboarding workflow errors with 'Invalid API Key' on Create Retell LLM node | Stale Retell API key hardcoded in n8n workflow 4Hx7aRdzMl5N0uJP + uses deprecated create-retell-llm endpoint | Not fixed — pre-existing, needs key rotation + API migration | hvac-standard, e2e-hvac-standard |
